...
@Module abstract class AccountModule {

  @ActivityScope @Binds abstract fun provideAccountView(
      accountFragment: AccountFragment): AccountContract.View

  @ActivityScope @Binds abstract fun provideAccountPresenter(
      accountPresenter: AccountPresenter): AccountContract.Presenter

  @ActivityScope @Binds abstract fun provideAccountEditView(
